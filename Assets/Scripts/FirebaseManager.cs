...
public class FirebaseManager : MonoBehaviour
{
    ...
    public TMP_InputField pwLoginField;
    ...
    public TMP_InputField pwRegisterField;
    public TMP_InputField cpwRegisterField;
    ...
    public void ClearRegisterFeilds()
    {
        ...
        pwRegisterField.text = "";
        cpwRegisterField.text = "";
    }
    ...
    public void LoginButton()
    {
        ...
        StartCoroutine(Login(emailLoginField.text, pwLoginField.text));
    }
    //Function for the register button
    public void RegisterButton()
    {
        //Call the register coroutine passing the email, password, and username
        StartCoroutine(Register(emailRegisterField.text, pwRegisterField.text, usernameRegisterField.text));
    }
    ...
    private IEnumerator Register(string _email, string _password, string _username)
    {
        ...
        else if (pwRegisterField.text != cpwRegisterField.text)
        {
